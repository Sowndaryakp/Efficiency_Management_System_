      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-6"> {/* Added spacing for better layout */}
        ...
        <div className="flex flex-col md:flex-row justify-between items-center mb-6"> {/* Responsive flex direction */}
          ...
          <div className="flex flex-col space-y-4"> {/* Changed to flex column for mobile responsiveness */}
            <div className="flex flex-col md:flex-row md:space-x-4"> {/* Flex for horizontal layout on larger screens */}
              <div className="flex flex-col w-full md:w-1/4">
                <label htmlFor="employeeName" className="font-semibold">Name:</label>
                <input 
                  id="employeeName"
              ...
              <div className="flex flex-col w-full md:w-1/4">
                <label htmlFor="employeeEcNo" className="font-semibold">EC No:</label>
                <input 
                  id="employeeEcNo"
              ...
              <div className="flex flex-col w-full md:w-1/4">
                <label htmlFor="employeeCc" className="font-semibold">CC:</label>
                <input 
                  id="employeeCc"
              ...
              <div className="flex flex-col w-full md:w-1/4">
                <label htmlFor="employeeShift" className="font-semibold">Shift:</label>
                <input 
                  id="employeeShift"
              ...
              <div key={item.id} className="flex flex-col md:flex-row md:space-x-4"> {/* Flex for horizontal layout on larger screens */}
                <div className="flex flex-col w-full md:w-1/5">
                  ...
                  <input 
                    ...
                    placeholder="Enter Activity Code No" 
                    className="border p-2" 
                  />
                </div>
                <div className="flex flex-col w-full md:w-1/5">
...
export default CasualLabourJobCardEntry;