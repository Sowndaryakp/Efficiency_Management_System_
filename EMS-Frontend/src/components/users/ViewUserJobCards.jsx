...
import { Table, Button, Space, Tag, Card, Row, Col, Form, Input, Select, Radio } from 'antd';
  ...
  const columns = [
    ...
    },
    {
      ...
      children: [
        ...
        {
          title: 'Flag',
          dataIndex: 'flag', // New data index for the flag
          key: 'flag',
          width: 100,
          render: (text, record) => (
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
              <span
                style={{
                  ...
                  height: '20px',
                  borderRadius: '50%',
                  backgroundColor: record.productionDetails[0].status === 'Complete' ? 'green' : 'red',
                  marginRight: '8px',
                }}
              />
              <span style={{ color: 'green' }}>
                {record.productionDetails[0].status === 'Complete' ? '✔️' : '❌'}
              </span>
            </div>
          ),
        },
...
const exportToExcel = () => {
  ...
  XLSX.utils.book_append_sheet(wb, ws, 'All Job Cards'); // Append the worksheet to the workbook
  XLSX.writeFile(wb, 'AllactivityCodes.xlsx'); // Export the workbook as an Excel file
};
    ...
    <div className="p-2">
      ...
      <Card>
        <Row gutter={[16, 16]}>
          ...
          <Table 
            columns={columns} 
            dataSource={paginatedData} // Use paginated data for display
